  ...
  return (
    <div className="relative">
      ...
      <div className="absolute left-[14%] -top-[20%] flex flex-col space-y-1">
        <img
          src={buttonStatesRef.current[6] ? FBottomTrigger : BottomTrigger}
          alt="Left Bottom Trigger"
          className={styles.BottomTrigger}
        />
        <div className="mt-4">
          <img
            src={buttonStatesRef.current[4] ? FTopTrigger : TopTrigger}
      ...
      <div className="absolute right-[14%] -top-[20%] flex flex-col space-y-1">
        <img
          src={buttonStatesRef.current[7] ? FBottomTrigger : BottomTrigger}
          alt="Right Bottom Trigger"
          className={styles.BottomTrigger}
        />
        <div className="mt-4">
          <img
            src={buttonStatesRef.current[5] ? FTopTrigger : TopTrigger}
