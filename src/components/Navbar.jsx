...
const getLinkClasses = (path, currentPath) => {
  ...
  const baseClasses = "flex items-center hover:bg-gray-700 p-2 rounded space-x-[0.9375rem] text-[1.5rem] font-russo";
  return path === currentPath ? `${baseClasses} ${activeClasses}` : baseClasses;
};
