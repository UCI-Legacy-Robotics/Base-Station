      ...
      <div className="h-full w-full grid grid-rows-2 gap-[1rem]">
        ...
        <div className="grid grid-cols-3 gap-[1rem]">
          ...
          <div
            ...
            onClick={() => handleContentClick("ZED Camera 1", "url_to_feed1")}
          >
          ...
          <div
            className={styles.Quadrant}
            onClick={() => handleContentClick("ZED Camera 2", "url_to_feed2")}
          >
          ...
          <div
            className={styles.Quadrant}
            onClick={() => handleContentClick("Arm ArduCam", "url_to_feed3")}
          >
